        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Foto</label><br/>
                    <?php if($pasien->foto): ?>
                    <img class="mb-2" src="<?= base_url($pasien->foto) ?>" width="100">
                    <br/>
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('NIK', $pasien->NIK); ?>" type="text" name="NIK" id="NIK" class="form-control" placeholder="NIK">
                    <?= form_error('NIK'); ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('noBPJS', $pasien->noBPJS); ?>" type="text" name="noBPJS" id="noBPJS" class="form-control" placeholder="Nomor BPJS Kesehatan">
                    <?= form_error('noBPJS'); ?>
                </div>
